...
export default function PomodoroTimer({ workMinutes = 25, breakMinutes = 5, onBreakStart }: PomodoroTimerProps) {
    ...
    return (
        <div
            className='flex flex-col items-center z-10 p-6 rounded-3xl shadow-[0_0_50px_rgba(16,185,129,0.6)] 
                    bg-gradient-to-br from-green-900 to-green-800 w-[40%] opacity-80 max-w-sm mx-auto'
        >
            <h1 className='text-2xl sm:text-3xl font-semibold text-white mb-4 transition-colors duration-500'>
            ...
            <div className='relative w-40 h-40 mb-4'>
                ...
                <div className='absolute inset-0 flex items-center justify-center text-3xl sm:text-4xl font-mono text-white'>
            ...
            <div className='flex flex-wrap justify-center gap-3 mt-2'>
                <button
                    ...
                    className='px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors duration-300'
                >
